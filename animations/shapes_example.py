...
for x in range(0,7):
    shapes.cell(image,[0,x],[randint(0,255), randint(0,255), randint(0,255)],0.1)
...
# more moving circles
shapes.circle(image,(3,4), 3, w, 1)
shapes.circle(image,(3,4), 3, e, 0)
shapes.circle(image,(4,4), 3, w, 1)
shapes.circle(image,(4,4), 3, e, 0)
shapes.circle(image,(3,4), 3, w, 1)
shapes.circle(image,(3,4), 3, e, 0)
...
for x in range(0, 10):
    shapes.circle(image,(4,4), 3, [randint(0,255), randint(0,255), randint(0,255)], 0.1) 
    shapes.circle(image,(4,4), 2, [randint(0,255), randint(0,255), randint(0,255)], 0.1)
    shapes.circle(image,(4,4), 1, [randint(0,255), randint(0,255), randint(0,255)], 0.1)    



shapes.circle(image,(4,4), 3, w, 1)
shapes.circle(image,(4,4), 3, b, 1)
shapes.circle(image,(4,4), 3, w, 1)
shapes.circle(image,(4,4), 3, b, 1)
shapes.circle(image,(4,4), 2, b, 1)
shapes.circle(image,(4,4), 1, b, 1)
shapes.circle(image,(4,4), 1, e, 1)
shapes.circle(image,(4,4), 2, e, 1)
shapes.circle(image,(4,4), 3, e, 1)
...
for x in range(0, 10):
    ...
    g = randint(0,255)
    b = randint(0,255)
    image1 = shapes.circle(image,(4,4), 3, [r, g, b], 0.1) 
    image2 = shapes.circle(image1,(4,4), 2, [r, g, b], 0.1)
    image3 = shapes.circle(image2,(4,4), 1, [r, g, b], 0.1)    

image3 = shapes.clear(image3)
